...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var mailTextFiedl: UITextField!
    ...
    func savePerson() {
        ...
        entityPerson.email = mailTextFiedl.text
        entityPerson.salario = Double(salaryTextField.text ?? "0") ?? 0.0 // Parseo simple a Double
